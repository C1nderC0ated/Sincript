...
*running* it; instead `tests/Run-Tests.ps1` (100 checks on stock Windows
...
Exit code `0` means all 100 checks passed; `1` means at least one failed, with
